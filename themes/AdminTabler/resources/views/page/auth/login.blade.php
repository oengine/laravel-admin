    <div class="page page-center">
        <div class="container container-tight py-4">
                ...
                <div class="card-body">
                    ...
                    <form wire:submit.prevent='DoWork()' autocomplete="off" novalidate>
                        <div class="mb-3">
                            ...
                            <input wire:model.defer='username' type="email" class="form-control"
                        ...
                        <div class="mb-2">
                            <label class="form-label">
                                ...
                                <span class="form-label-description">
                                    <a href="{{ route('auth.forgot-password') }}">I forgot password</a>
                                </span>
                            </label>
                        ...
                        <div class="mb-2">
                            <label class="form-check">
                                <input wire:model.defer='isRememberMe' type="checkbox" class="form-check-input" />
            ...
            <div class="text-center text-muted mt-3">
                Don't have account yet? <a href="{{ route('auth.sign-up') }}" tabindex="-1">Sign up</a>
            </div>
        </div>
    </div>
