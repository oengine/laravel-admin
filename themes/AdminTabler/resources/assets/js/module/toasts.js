export class ToastsModule {
  ...
  addToast(
    ...
    const contenthtml = title
      ? `
    <div class="toast ${metaType??''}" role="alert" aria-live="assertive" aria-atomic="true">
    ...
    <div class="toast-body">
     ${content}
      ...
      : `
  <div class="toast align-items-center ${metaType??''}" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
    <div class="toast-body">
    ${content}
    </div>
  ...
  init() {
    this.manager.on("platform::message", (el) => {
      const { message, meta, type } = el;
      const { postion, title, type: metaType } = meta;
      this.addToast(message, postion, title, metaType ?? type);
    });
