...
/* harmony import */ var _tabler_core_dist_js_tabler__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @tabler/core/dist/js/tabler */ "./node_modules/@tabler/core/dist/js/tabler.js");
/* harmony import */ var _tabler_core_dist_js_tabler__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_tabler_core_dist_js_tabler__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _module_toasts__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./module/toasts */ "./resources/assets/js/module/toasts.js");


if (window.ModulePlatform) {
  window.ModulePlatform.register("THEME_TOASTS_MODULE", new _module_toasts__WEBPACK_IMPORTED_MODULE_1__.ToastsModule());
  window.showToast = function (message) {
    var title = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : undefined;
    var postion = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : undefined;
...
/***/ "./resources/assets/js/module/toasts.js":
/*!**********************************************!*\
  !*** ./resources/assets/js/module/toasts.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "ToastsModule": () => (/* binding */ ToastsModule)
/* harmony export */ });
...
var ToastsModule = /*#__PURE__*/function () {
  function ToastsModule() {
    _classCallCheck(this, ToastsModule);
    _defineProperty(this, "manager", undefined);
    _defineProperty(this, "postion", {
    ...
    _defineProperty(this, "postion_el", {});
  }
  _createClass(ToastsModule, [{
    key: "addToast",
    value: function addToast(content) {
      var postion = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "bottom_right";
      var title = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : undefined;
      var metaType = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : undefined;
      var toastContainer = this.postion_el["bottom_right"];
      if (postion && this.postion_el[postion]) {
        toastContainer = this.postion_el[postion];
      }
      var contenthtml = title ? "\n    <div class=\"toast ".concat(metaType !== null && metaType !== void 0 ? metaType : '', "\" role=\"alert\" aria-live=\"assertive\" aria-atomic=\"true\">\n    <div class=\"toast-header\">\n      <strong class=\"me-auto\">").concat(title, "</strong>\n      <button type=\"button\" class=\"btn-close\" data-bs-dismiss=\"toast\" aria-label=\"Close\"></button>\n    </div>\n    <div class=\"toast-body\">\n     ").concat(content, "\n    </div>\n  </div>") : "\n  <div class=\"toast align-items-center ".concat(metaType !== null && metaType !== void 0 ? metaType : '', "\" role=\"alert\" aria-live=\"assertive\" aria-atomic=\"true\">\n  <div class=\"d-flex\">\n    <div class=\"toast-body\">\n    ").concat(content, "\n    </div>\n    <button type=\"button\" class=\"btn-close me-2 m-auto\" data-bs-dismiss=\"toast\" aria-label=\"Close\"></button>\n  </div>\n</div>");
      var toastEl = this.manager.htmlToElement(contenthtml.trim());
      console.log(toastContainer);
      console.log(toastEl);
      console.log(contenthtml);
      toastContainer.appendChild(toastEl);
      var toast = new globalThis.bootstrap.Toast(toastEl);
      toast.show();
    }
  }, {
    key: "init",
    value: function init() {
      var _this = this;
      this.manager.on("platform::message", function (el) {
        var message = el.message,
          meta = el.meta,
          type = el.type;
        var postion = meta.postion,
          title = meta.title,
          metaType = meta.type;
        _this.addToast(message, postion, title, metaType !== null && metaType !== void 0 ? metaType : type);
        console.log(el);
      });
      Object.keys(this.postion).forEach(function (key) {
        _this.postion_el[key] = _this.manager.appendHtmlToBody("<div class=\"toast-container p-3 ".concat(_this.postion[key], "\" id=\"toast-").concat(key, "\">"));
      });
    }
  }, {
    key: "loading",
