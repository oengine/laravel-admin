...
class MenuBuilder extends HtmlBuilder
{
    ...
    protected MenuItemBuilder $parent;
    ...
    public function __construct($position = '', $sub = false, $level = 0, $parent)
    {
    ...
    public function link($link, $text, $icon = '', $attributes = [], $sort = -1): self
    {
    ...
    public function div($text = '', $icon = '', $attributes = [], $sort  = -1): self
    {
        $this->items[] = new MenuItemBuilder([
    ...
    public function tag($tag, $text, $icon = '', $attributes = [], $sort  = -1)
    {
        $this->items[] = new MenuItemBuilder([
    ...
    public function button($text, $icon = '', $attributes = [], $sort  = -1): self
    {
        $this->items[] = new MenuItemBuilder([
    ...
    protected function render()
    {
        ...
        usort($this->items, fn ($a, $b) => $a->getValueSort() <=> $b->getValueSort());
        foreach ($this->items as $item) {
            echo $item->toHtml();
        }
        echo '</div>';
